...
@php $header = 'Completed Tasks' @endphp
    ...
    @if($tasks->count() > 0)
        ...
        <div class="sm:flex sm:items-center space-x-4">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Here we have list of completed tasks.</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:flex-none">
                <a href="{{ route('dashboard-tasks') }}" class="block rounded-md bg-green-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 ">Back</a>
            </div>
            <div class="mt-4 sm:mt-0 sm:flex-none">
                <a href="" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">New Task</a>
            </div>
        </div>

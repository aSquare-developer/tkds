...
@section('content')
    ...
    <div class="mb-3 sm:flex sm:items-center space-x-4">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Here you can see the list of people who want to take trial classes.</p>
        </div>
        <div class="mt-4 sm:mt-0 sm:flex-none">
            <a href="{{ route('dashboard.trial.lessons.completed') }}" class="block rounded-md bg-green-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 ">Completed</a>
        </div>
    </div>

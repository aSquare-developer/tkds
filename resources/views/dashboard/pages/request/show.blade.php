                        ...
                        <!--
                                ...
                                <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                        <span class="truncate font-medium">
                                            <a href="{{ Storage::url('public/Leping_TKD.pdf') }}" target="_blank">
                                                {{ basename('Leping_TKD.pdf') }}
                                            </a>
                                        </span>
                                    </div>
                                </div>
                                <div class="ml-4 flex-shrink-0">
                                    <a href="{{ route('dashboard-request-sendContract', [ 'id' => $request->id, 'fileId' => 1]) }}" class="font-medium text-indigo-600 hover:text-indigo-500">Send</a>
                                </div>
                            </li>
                            <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                        <span class="truncate font-medium">
                                            <a href="{{ Storage::url('public/Leping_TT.pdf') }}" target="_blank">
                                                {{ basename('Leping_TT.pdf') }}
                                            </a>
                                        </span>
                                    </div>
                                </div>
                                <div class="ml-4 flex-shrink-0">
                                    <a href="{{ route('dashboard-request-sendContract', [ 'id' => $request->id, 'fileId' => 2]) }}" class="font-medium text-indigo-600 hover:text-indigo-500">Send</a>
                                </div>
                            </li>
                            -->
                            ...
                            <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                        <span class="truncate font-medium">
                                            <a href="{{ Storage::url('public/Leping_TKDS.pdf') }}" target="_blank">
